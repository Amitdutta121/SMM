<?php
	...
	if(!isset($_SESSION["username_main"])){
        ...
        <ul class="nav navbar-nav">
		  ...
		  <?php
			...
			<div class="balance" style="margin-top:14px">
				<span style="font-size:17px" class="label label-success"><?php echo "$".$balance; ?></span>
			</div>
		  </li>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <?php echo $_SESSION["username_main"]; ?>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $_SESSION["username_main"]; ?></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<?php
			if($_SESSION["main_user_type"]=="Admininistrator"){
				...
				<li class="<?php if($pagename=="order.php") {echo "active";} else {echo "";} ?>"><a href="order.php"><i class="fa fa-link"></i> <span>Order Services</span></a></li>
				...
				<li class="<?php if($pagename=="managenews.php") {echo "active";} else {echo "";} ?>"><a href="managenews.php"><i class="fa fa-link"></i> <span>Manage news</span></a></li>
        ...
        <li class="<?php if($pagename=="order.php") {echo "active";} else {echo "";} ?>"><a href="order.php"><i class="fa fa-link"></i> <span>Order Service</span></a></li>
		<li class="<?php if($pagename=="myorder.php") {echo "active";} else {echo "";} ?>"><a href="myorder.php"><i class="fa fa-link"></i> <span>My Order</span></a></li>
